...
N 1120 -640 1120 -540 {lab=VIN}
N 940 -510 1060 -510 {lab=#net1}
N 1120 -480 1120 -390 {lab=VREG}
N 1060 -510 1080 -510 {lab=#net1}
...
spiceprefix=X
mult=1}
C {lab_pin.sym} 1190 -510 0 1 {name=p3 sig_type=std_logic lab=VSS}
...
C {isource.sym} 1440 -350 0 0 {name=I3 value="50m"
 savecurrent=false}
...
.endc
"}
C {vsource.sym} 1740 -730 0 0 {name=V4 value="1.8" savecurrent=false}
...
C {sky130_fd_pr/corner.sym} 1730 -470 0 0 {name=CORNER2 only_toplevel=true corner=ss}
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 1100 -510 0 0 {name=M3
W=880
L=0.5
nf=64
mult=100
