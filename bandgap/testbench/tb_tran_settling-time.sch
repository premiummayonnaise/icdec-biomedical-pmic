...
N 1330 -140 1330 -120 {lab=#net3}
N 1330 -170 1330 -140 {lab=#net3}
...
C {lab_pin.sym} 1330 -60 0 0 {name=p7 sig_type=std_logic lab=VSS}
C {ammeter.sym} 1330 -90 0 0 {name=Vmeas savecurrent=true spice_ignore=0}
