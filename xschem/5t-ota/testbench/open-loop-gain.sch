...
C {devices/code_shown.sym} 820 -860 0 0 {name=NGSPICE only_toplevel=true
value="
...
C {sky130_fd_pr/corner.sym} 640 -610 0 0 {name=CORNER only_toplevel=true corner=tt}
...
C {icdec-biomedical-pmic/xschem/5t-ota/schematics/5t-ota.sym} 20 -680 0 0 {name=x2}
C {lab_pin.sym} 560 -520 0 1 {name=p5 lab=IBIAS}
C {lab_pin.sym} 560 -580 0 0 {name=p7 sig_type=std_logic lab=VDD}
C {isource.sym} 560 -550 0 0 {name=I4 value="10u" savecurrent=false}
...
C {icdec-biomedical-pmic/xschem/5t-ota/schematics/5t-ota.sym} 20 -430 0 0 {name=x1}
C {lab_pin.sym} 120 -680 0 0 {name=p20 lab=IBIAS}
C {vsource.sym} 560 -670 0 0 {name=V1 value="ac 1m DC 1.8" savecurrent=false}
...
C {icdec-biomedical-pmic/xschem/5t-ota/schematics/5t-ota.sym} 40 -150 0 0 {name=x3}
